...
- PMU
	- 工作方式
		- 加压测流，加流测压，直接测压
	- 电机驱动，<img src="https://latex.codecogs.com/gif.latex?15V"/>
	- 电流驱动，<img src="https://latex.codecogs.com/gif.latex?\pm300MA"/>
	- 全量程电压电流箝位保护
	- 16bit施加，测量精度
	- 采用Kelvin连接法测试DUT
- DPS
	- 加压，<img src="https://latex.codecogs.com/gif.latex?\pm15V"/>
	- 测流，<img src="https://latex.codecogs.com/gif.latex?\pm250MA"/>
- PGCB & NCHB
	- 产生驱动时钟，比较时钟
	- 14个继电器控制位
	- 产生驱动电平，比较电平
